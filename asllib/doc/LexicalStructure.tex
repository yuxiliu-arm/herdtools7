...
\inferrule[token]{
  ...
  a_1(s_1, s_2) \scanarrow \ts \terminateas \LexicalError
}{
...
\inferrule[no\_match]{
  ...
  \scanstring(\buff, s) \scanarrow \LexicalError
}
\end{mathpar}
...
\inferrule[char]{
  ...
  \scanstring(\buff \concat t, s_2) \scanarrow \tstwo \terminateas \LexicalError
}{
...
\inferrule[end]{
  ...
  \aslscan(\spectoken, s_2) \scanarrow \tstwo \terminateas \LexicalError
}{
...
\stringescape(s_1, s_2) \triangleq \begin{cases}
  \Tstringchar(10) & s_1 = \textbackslash\texttt{\;\;n}\\
  \Tstringchar(9) & s_1 = \textbackslash\texttt{\;\;t}\\
  \Tstringchar(34) & s_1 = \textbackslash\texttt{\;\;"}\\
  \Tstringchar(92) & s_1 = \textbackslash\texttt{\;\;}\textbackslash\\
\end{cases}
\]
