...
to the number of calls being evaluated for those subprograms.
...
\begin{mathpar}
  \inferrule[\ref{sec:SemanticsRule.Binop}]{
    \inferrule[\ref{sec:SemanticsRule.ELit}]{}{ \evalexpr{\emptyenv, \veone} \evalarrow \Normal(\nvint(1), \emptyenv) } \\\\
    \inferrule[\ref{sec:SemanticsRule.ELit}]{}{ \evalexpr{\emptyenv, \vetwo} \evalarrow \Normal(\nvint(2), \emptyenv) } \\\\
    \inferrule[\ref{sec:SemanticsRule.BinopValues}]{}{\binoprel(\PLUS, \nvint(1), \nvint(2)) \evalarrow \nvint(3)}
  }
  {
...
\begin{mathpar}
  \inferrule[\ref{sec:SemanticsRule.Binop}]{
    \inferrule[\ref{sec:SemanticsRule.ELit}]{}{ \evalexpr{\emptyenv, \vefour} \evalarrow \Normal(\nvint(4), \emptyenv) } \\\\
    \inferrule[\ref{sec:SemanticsRule.ELit}]{}{ \evalexpr{\emptyenv, \vefive} \evalarrow \Normal(\nvint(5), \emptyenv) } \\\\
    \inferrule[\ref{sec:SemanticsRule.BinopValues}]{}{\binoprel(\PLUS, \nvint(4), \nvint(5)) \evalarrow \nvint(9)}
  }
  {
...
\begin{mathpar}
  \inferrule[\ref{sec:SemanticsRule.Binop}]{
    ...
    \inferrule[\ref{sec:SemanticsRule.BinopValues}]{}{\binoprel(\MUL, \nvint(3), \nvint(9)) \evalarrow \nvint(27)}
  }
  {
