...
% \newcommand\BNOT[0]{\hyperlink{ast-bnot}{\textastlabel{BNOT}}} % Boolean inversion
% \newcommand\NEG[0]{\hyperlink{ast-neg}{\textastlabel{NEG}}} % Integer or real negation
% \newcommand\NOT[0]{\hyperlink{ast-not}{\textastlabel{NOT}}} % Bitvector bitwise inversion

% \newcommand\AND[0]{\hyperlink{ast-and}{\textastlabel{AND}}} % Bitvector bitwise and
% \newcommand\BAND[0]{\hyperlink{ast-band}{\textastlabel{BAND}}} % Boolean and
% \newcommand\BEQ[0]{\hyperlink{ast-beq}{\textastlabel{BEQ}}} % Boolean equivalence
% \newcommand\BOR[0]{\hyperlink{ast-bor}{\textastlabel{BOR}}} % Boolean or
% \newcommand\BVCONCAT[0]{\hyperlink{ast-bvconcat}{\textastlabel{BV\_CONCAT}}} % Concatenation for bitvectors
% \newcommand\STRCONCAT[0]{\hyperlink{ast-strconcat}{\textastlabel{STR\_CONCAT}}} % Concatenation for bitvectors
% \newcommand\DIV[0]{\hyperlink{ast-div}{\textastlabel{DIV}}} % Integer division
% \newcommand\DIVRM[0]{\hyperlink{ast-divrm}{\textastlabel{DIVRM}}} % Inexact integer division, with rounding towards negative infinity.
% \newcommand\XOR[0]{\hyperlink{ast-xor}{\textastlabel{XOR}}} % Bitvector bitwise exclusive or
% \newcommand\EQOP[0]{\hyperlink{ast-eqop}{\textastlabel{EQ}}} % Equality on two base values of same type
% \newcommand\GT[0]{\hyperlink{ast-gt}{\textastlabel{GT}}} % Greater than for int or reals
% \newcommand\GEQ[0]{\hyperlink{ast-geq}{\textastlabel{GE}}} % Greater or equal for int or reals
% \newcommand\IMPL[0]{\hyperlink{ast-impl}{\textastlabel{IMPL}}} % Boolean implication
% \newcommand\LT[0]{\hyperlink{ast-lt}{\textastlabel{LT}}} % Less than for int or reals
% \newcommand\LEQ[0]{\hyperlink{ast-leq}{\textastlabel{LE}}} % Less or equal for int or reals
% \newcommand\MOD[0]{\hyperlink{ast-mod}{\textastlabel{MOD}}} % Remainder of integer division
% \newcommand\MINUS[0]{\hyperlink{ast-minus}{\textastlabel{SUB}}} % Subtraction for int or reals or bitvectors
% \newcommand\MUL[0]{\hyperlink{ast-mul}{\textastlabel{MUL}}} % Multiplication for int or reals or bitvectors
% \newcommand\NEQ[0]{\hyperlink{ast-neq}{\textastlabel{NE}}} % Non equality on two base values of same type
% \newcommand\OR[0]{\hyperlink{ast-or}{\textastlabel{OR}}} % Bitvector bitwise or
% \newcommand\PLUS[0]{\hyperlink{ast-plus}{\textastlabel{ADD}}} % Addition for int or reals or bitvectors
% \newcommand\POW[0]{\hyperlink{ast-pow}{\textastlabel{POW}}} % Exponentiation for integers
% \newcommand\RDIV[0]{\hyperlink{ast-rdiv}{\textastlabel{RDIV}}} % Division for reals
% \newcommand\SHL[0]{\hyperlink{ast-shl}{\textastlabel{SHL}}} % Shift left for integers
% \newcommand\SHR[0]{\hyperlink{ast-shr}{\textastlabel{SHR}}} % Shift right for integers
...
% \newcommand\wellconstrained[0]{\hyperlink{ast-wellconstrained}{\textastlabel{WellConstrained}}}
% \newcommand\pendingconstrained[0]{\hyperlink{ast-pendingconstrained}{\textastlabel{PendingConstrained}}}
% \newcommand\parameterized[0]{\hyperlink{ast-parameterized}{\textastlabel{Parameterized}}}
% \newcommand\constraintexact[0]{\hyperlink{ast-constraintexact}{\textastlabel{Constraint\_Exact}}}
% \newcommand\constraintrange[0]{\hyperlink{ast-constraintrange}{\textastlabel{Constraint\_Range}}}
...
% \newcommand\qualifier[0]{\hyperlink{ast-qualifier}{\textsf{func\_qualifier}}}
...
% \newcommand\PrecisionFull[0]{\hyperlink{precision-full}{\textastlabel{Precision\_Full}}}
% \newcommand\PrecisionLost[0]{\hyperlink{precision-lost}{\textastlabel{Precision\_Lost}}}

% % Expression labels
% \newcommand\ELiteral[0]{\hyperlink{ast-eliteral}{\textastlabel{E\_Literal}}}
% \newcommand\EVar[0]{\hyperlink{ast-evar}{\textastlabel{E\_Var}}}
% \newcommand\EATC[0]{\hyperlink{ast-eatc}{\textastlabel{E\_ATC}}}
% \newcommand\EBinop[0]{\hyperlink{ast-ebinop}{\textastlabel{E\_Binop}}}
% \newcommand\EUnop[0]{\hyperlink{ast-eunop}{\textastlabel{E\_Unop}}}
% \newcommand\ECall[0]{\hyperlink{ast-ecall}{\textastlabel{E\_Call}}}
% \newcommand\ESlice[0]{\hyperlink{ast-eslice}{\textastlabel{E\_Slice}}}
% \newcommand\ECond[0]{\hyperlink{ast-econd}{\textastlabel{E\_Cond}}}
% \newcommand\EGetArray[0]{\hyperlink{ast-egetarray}{\textastlabel{E\_GetArray}}}
% \newcommand\EGetEnumArray[0]{\hyperlink{ast-egetenumarray}{\textastlabel{E\_GetEnumArray}}}
% \newcommand\EGetCollectionFields[0]{\hyperlink{ast-egetcollectionfields}{\textastlabel{E\_GetCollectionFields}}}
% \newcommand\EGetField[0]{\hyperlink{ast-egetfield}{\textastlabel{E\_GetField}}}
% \newcommand\EGetItem[0]{\hyperlink{ast-egetitem}{\textastlabel{E\_GetItem}}}
% \newcommand\EGetFields[0]{\hyperlink{ast-egetfields}{\textastlabel{E\_GetFields}}}
% \newcommand\ERecord[0]{\hyperlink{ast-erecord}{\textastlabel{E\_Record}}}
% \newcommand\EArray[0]{\hyperlink{ast-earray}{\textastlabel{E\_Array}}}
% \newcommand\EEnumArray[0]{\hyperlink{ast-eenumarray}{\textastlabel{E\_EnumArray}}}
% \newcommand\ETuple[0]{\hyperlink{ast-etuple}{\textastlabel{E\_Tuple}}}
% \newcommand\EArbitrary[0]{\hyperlink{ast-earbitrary}{\textastlabel{E\_Arbitrary}}}
% \newcommand\EPattern[0]{\hyperlink{ast-epattern}{\textastlabel{E\_Pattern}}}

% % Left-hand-side expression labels
% \newcommand\LEDiscard[0]{\hyperlink{ast-lediscard}{\textastlabel{LE\_Discard}}}
% \newcommand\LEVar[0]{\hyperlink{ast-levar}{\textastlabel{LE\_Var}}}
% \newcommand\ProseLESlice{\hyperlink{ast-leslice}{left-hand-side slicing expression}}
% \newcommand\LESlice{\hyperlink{ast-leslice}{\textastlabel{LE\_Slice}}}
% \newcommand\LESetArray[0]{\hyperlink{ast-lesetarray}{\textastlabel{LE\_SetArray}}}
% \newcommand\LESetEnumArray[0]{\hyperlink{ast-lesetenumarray}{\textastlabel{LE\_SetEnumArray}}}
% \newcommand\LESetCollectionFields[0]{\hyperlink{ast-lesetcollectionfields}{\textastlabel{LE\_SetCollectionFields}}}
% \newcommand\LESetField[0]{\hyperlink{ast-lesetfield}{\textastlabel{LE\_SetField}}}
% \newcommand\LESetFields[0]{\hyperlink{ast-lesetfields}{\textastlabel{LE\_SetFields}}}
% \newcommand\LEDestructuring[0]{\hyperlink{ast-ledestructuring}{\textastlabel{LE\_Destructuring}}}

% % Statement labels
% \newcommand\SPass[0]{\hyperlink{ast-spass}{\textastlabel{S\_Pass}}}
% \newcommand\SAssign[0]{\hyperlink{ast-sassign}{\textastlabel{S\_Assign}}}
% \newcommand\SReturn[0]{\hyperlink{ast-sreturn}{\textastlabel{S\_Return}}}
% \newcommand\SSeq[0]{\hyperlink{ast-sseq}{\textastlabel{S\_Seq}}}
% \newcommand\SCall[0]{\hyperlink{ast-scall}{\textastlabel{S\_Call}}}
% \newcommand\SCond[0]{\hyperlink{ast-scond}{\textastlabel{S\_Cond}}}
% \newcommand\SDecl[0]{\hyperlink{ast-sdecl}{\textastlabel{S\_Decl}}}
% \newcommand\SAssert[0]{\hyperlink{ast-sassert}{\textastlabel{S\_Assert}}}
% \newcommand\SWhile[0]{\hyperlink{ast-swhile}{\textastlabel{S\_While}}}
% \newcommand\SRepeat[0]{\hyperlink{ast-srepeat}{\textastlabel{S\_Repeat}}}
% \newcommand\SFor[0]{\hyperlink{ast-sfor}{\textastlabel{S\_For}}}
% \newcommand\SThrow[0]{\hyperlink{ast-sthrow}{\textastlabel{S\_Throw}}}
% \newcommand\STry[0]{\hyperlink{ast-stry}{\textastlabel{S\_Try}}}
% \newcommand\SPrint[0]{\hyperlink{ast-sprint}{\textastlabel{S\_Print}}}
% \newcommand\SPragma[0]{\hyperlink{ast-spragma}{\textastlabel{S\_Pragma}}}
% \newcommand\SUnreachable[0]{\hyperlink{ast-sunreachable}{\textastlabel{S\_Unreachable}}}

% % Literal labels
% \newcommand\lint[0]{\hyperlink{ast-lint}{\textastlabel{L\_Int}}}
% \newcommand\lbool[0]{\hyperlink{ast-lbool}{\textastlabel{L\_Bool}}}
% \newcommand\lreal[0]{\hyperlink{ast-lreal}{\textastlabel{L\_Real}}}
% \newcommand\lbitvector[0]{\hyperlink{ast-lbitvector}{\textastlabel{L\_Bitvector}}}
% \newcommand\lstring[0]{\hyperlink{ast-lstring}{\textastlabel{L\_String}}}
% \newcommand\llabel[0]{\hyperlink{ast-llabel}{\textastlabel{L\_Label}}}

% % Type labels
% \newcommand\TInt[0]{\hyperlink{ast-tint}{\textastlabel{T\_Int}}}
% \newcommand\TReal[0]{\hyperlink{ast-treal}{\textastlabel{T\_Real}}}
% \newcommand\TString[0]{\hyperlink{ast-tstring}{\textastlabel{T\_String}}}
% \newcommand\TBool[0]{\hyperlink{ast-tbool}{\textastlabel{T\_Bool}}}
% \newcommand\TBits[0]{\hyperlink{ast-tbits}{\textastlabel{T\_Bits}}}
% \newcommand\TEnum[0]{\hyperlink{ast-tenum}{\textastlabel{T\_Enum}}}
% \newcommand\TTuple[0]{\hyperlink{ast-ttuple}{\textastlabel{T\_Tuple}}}
% \newcommand\TArray[0]{\hyperlink{ast-tarray}{\textastlabel{T\_Array}}}
% \newcommand\TRecord[0]{\hyperlink{ast-trecord}{\textastlabel{T\_Record}}}
% \newcommand\TException[0]{\hyperlink{ast-texception}{\textastlabel{T\_Exception}}}
% \newcommand\TCollection[0]{\hyperlink{ast-tcollection}{\textastlabel{T\_Collection}}}
% \newcommand\TNamed[0]{\hyperlink{ast-tnamed}{\textastlabel{T\_Named}}}

% \newcommand\BitFieldSimple[0]{\hyperlink{ast-bitfieldsimple}{\textastlabel{BitField\_Simple}}}
% \newcommand\BitFieldNested[0]{\hyperlink{ast-bitfieldnested}{\textastlabel{BitField\_Nested}}}
% \newcommand\BitFieldType[0]{\hyperlink{ast-bitfieldtype}{\textastlabel{BitField\_Type}}}

% \newcommand\ConstraintExact[0]{\hyperlink{ast-constraintexact}{\textastlabel{Constraint\_Exact}}}
% \newcommand\ConstraintRange[0]{\hyperlink{ast-constraintrange}{\textastlabel{Constraint\_Range}}}

% % Array index labels
% \newcommand\ArrayLengthExpr[0]{\hyperlink{ast-arraylengthexpr}{\textastlabel{ArrayLength\_Expr}}}
% \newcommand\ArrayLengthEnum[0]{\hyperlink{ast-arraylengthenum}{\textastlabel{ArrayLength\_Enum}}}

% % Slice labels
% \newcommand\SliceSingle[0]{\hyperlink{ast-slicesingle}{\textastlabel{Slice\_Single}}}
% \newcommand\SliceRange[0]{\hyperlink{ast-slicerange}{\textastlabel{Slice\_Range}}}
% \newcommand\SliceLength[0]{\hyperlink{ast-slicelength}{\textastlabel{Slice\_Length}}}
% \newcommand\SliceStar[0]{\hyperlink{ast-slicestar}{\textastlabel{Slice\_Star}}}

% % Pattern labels
% \newcommand\PatternAll[0]{\hyperlink{ast-patternall}{\textastlabel{Pattern\_All}}}
% \newcommand\PatternAny[0]{\hyperlink{ast-patternany}{\textastlabel{Pattern\_Any}}}
% \newcommand\PatternGeq[0]{\hyperlink{ast-patterngeq}{\textastlabel{Pattern\_Geq}}}
% \newcommand\PatternLeq[0]{\hyperlink{ast-patternleq}{\textastlabel{Pattern\_Leq}}}
% \newcommand\PatternNot[0]{\hyperlink{ast-patternnot}{\textastlabel{Pattern\_Not}}}
% \newcommand\PatternRange[0]{\hyperlink{ast-patternrange}{\textastlabel{Pattern\_Range}}}
% \newcommand\PatternSingle[0]{\hyperlink{ast-patternsingle}{\textastlabel{Pattern\_Single}}}
% \newcommand\PatternMask[0]{\hyperlink{ast-patternmask}{\textastlabel{Pattern\_Mask}}}
% \newcommand\PatternTuple[0]{\hyperlink{ast-patterntuple}{\textastlabel{Pattern\_Tuple}}}

% % Local declarations
% \newcommand\LDIVar[0]{\hyperlink{ast-ldivar}{\textastlabel{LDI\_Var}}}
% \newcommand\LDITuple[0]{\hyperlink{ast-ldituple}{\textastlabel{LDI\_Tuple}}}

% \newcommand\LDKVar[0]{\hyperlink{ast-ldkvar}{\textastlabel{LDK\_Var}}}
% \newcommand\LDKLet[0]{\hyperlink{ast-ldklet}{\textastlabel{LDK\_Let}}}

% \newcommand\GDKConstant[0]{\hyperlink{ast-gdkconstant}{\textastlabel{GDK\_Constant}}}
% \newcommand\GDKConfig[0]{\hyperlink{ast-gdkconfig}{\textastlabel{GDK\_Config}}}
% \newcommand\GDKLet[0]{\hyperlink{ast-gdklet}{\textastlabel{GDK\_Let}}}
% \newcommand\GDKVar[0]{\hyperlink{ast-gdkvar}{\textastlabel{GDK\_Var}}}

% \newcommand\Pure[0]{\hyperlink{ast-pure}{\textastlabel{Pure}}}
% \newcommand\Readonly[0]{\hyperlink{ast-readonly}{\textastlabel{Readonly}}}
% \newcommand\Noreturn[0]{\hyperlink{ast-noreturn}{\textastlabel{Noreturn}}}

% \newcommand\Impdef[0]{\hyperlink{ast-impdef}{\textastlabel{Impdef}}}
...
% \newcommand\Implementation[0]{\hyperlink{ast-implementation}{\textastlabel{Implementation}}}
...
% \newcommand\STFunction[0]{\hyperlink{ast-stfunction}{\textastlabel{ST\_Function}}}
% \newcommand\STGetter[0]{\hyperlink{ast-stgetter}{\textastlabel{ST\_Getter}}}
% \newcommand\STSetter[0]{\hyperlink{ast-stsetter}{\textastlabel{ST\_Setter}}}
% \newcommand\STProcedure[0]{\hyperlink{ast-stprocedure}{\textastlabel{ST\_Procedure}}}

% \newcommand\DFunc[0]{\hyperlink{ast-dfunc}{\textastlabel{D\_Func}}}
% \newcommand\DGlobalStorage[0]{\hyperlink{ast-dglobalstorage}{\textastlabel{D\_GlobalStorage}}}
% \newcommand\DTypeDecl[0]{\hyperlink{ast-dtypedecl}{\textastlabel{D\_TypeDecl}}}
% \newcommand\DPragma[0]{\hyperlink{ast-dpragma}{\textastlabel{D\_Pragma}}}
...
% \newcommand\evalexprsefname[0]{\hyperlink{def-evalexprsef}{\textfunc{eval\_expr\_sef}}}
% \newcommand\evalexprsef[1]{\evalexprsefname(#1)}
% \newcommand\evallexprname[0]{\hyperlink{def-evallexpr}{\textfunc{eval\_lexpr}}}
% \newcommand\evallexpr[1]{\evallexprname(#1)}
...
% \newcommand\evalpatternname[0]{\hyperlink{def-evalpattern}{\textfunc{eval\_pattern}}}
% \newcommand\evalpattern[1]{\evalpatternname(#1)}
...
% \newcommand\evalblockname[0]{\hyperlink{def-evalblock}{\textfunc{eval\_block}}}
% \newcommand\evalblock[1]{\evalblockname(#1)}
...
% \newcommand\evalcatchersname[0]{\hyperlink{def-evalcatchers}{\textfunc{eval\_catchers}}}
% \newcommand\evalcatchers[1]{\evalcatchersname(#1)}
...
% \newcommand\getstacksize[0]{\hyperlink{def-getstacksize}{\textfunc{get\_stack\_size}}}
% \newcommand\setstacksize[0]{\hyperlink{def-setstacksize}{\textfunc{set\_stack\_size}}}
% \newcommand\incrstacksize[0]{\hyperlink{def-incrstacksize}{\textfunc{incr\_stack\_size}}}
% \newcommand\decrstacksize[0]{\hyperlink{def-decrstacksize}{\textfunc{decr\_stack\_size}}}
...
% \newcommand\DynamicError[0]{\hyperlink{def-error}{\textsf{DynError}}}
% \newcommand\DynamicErrorConfigurationTerm[0]{\hyperlink{def-error}{dynamic error configuration}}
...
% \newcommand\TPurity[0]{\hyperlink{def-tpurity}{\textsf{TPurity}}}
% \newcommand\purity[0]{\hyperlink{def-tpurity}{purity}}
% \newcommand\purities[0]{\hyperlink{def-tpurity}{purities}}
% \newcommand\purityless[0]{\hyperlink{def-purityless}{<_{\text{pure}}}}
% \newcommand\puritygeq[0]{\hyperlink{def-puritygeq}{\geq_{\text{pure}}}}
% \newcommand\SEPure[0]{\hyperlink{def-sepure}{\textsf{SE\_Pure}}}
% \newcommand\SEReadonly[0]{\hyperlink{def-sereadonly}{\textsf{SE\_Readonly}}}
% \newcommand\SEImpure[0]{\hyperlink{def-seimpure}{\textsf{SE\_Impure}}}

% \newcommand\TSideEffect[0]{\hyperlink{def-tsideeffect}{\textsf{TSideEffect}}}
% \newcommand\TSideEffectSet[0]{\pow{\TSideEffect}}
% \newcommand\LocalEffect[0]{\hyperlink{def-localeffect}{\textsf{LocalEffect}}}
% \newcommand\GlobalEffect[0]{\hyperlink{def-globaleffect}{\textsf{GlobalEffect}}}
% \newcommand\Immutability[0]{\hyperlink{def-immutability}{\textsf{Immutability}}}
...
% \newcommand\constrainedintegers[0]{\hyperlink{def-checkconstrainedinteger}{constrained integers}}
...
% \newcommand\Prosesingulartypes[0]{\hyperlink{def-issingular}{singular types}}
...
% \newcommand\LocalEffectTerm[0]{\hyperlink{def-localeffectterm}{local side effect descriptor}}
% \newcommand\GlobalEffectTerm[0]{\hyperlink{def-globaleffectterm}{global side effect descriptor}}
% \newcommand\ImmutabilityTerm[0]{\hyperlink{def-immutabilityterm}{immutability side effect descriptor}}

% \newcommand\staticallyevaluable[0]{\hyperlink{def-staticallyevaluable}{statically evaluable}}
% \newcommand\pure[0]{\hyperlink{def-sesispure}{pure}}
% \newcommand\readonly[0]{\hyperlink{def-sesisreadonly}{read-only}}
...
% \newcommand\annotatelexprname[0]{\hyperlink{def-annotatelexpr}{\textfunc{annotate\_lexpr}}}
% \newcommand\annotatelexpr[1]{\annotatelexprname(#1)}
...
% \newcommand\annotateblockname[0]{\hyperlink{def-annotateblock}{\textfunc{annotate\_block}}}
% \newcommand\annotateblock[1]{\annotateblockname(#1)}
...
% \newcommand\annotatecatchername[0]{\hyperlink{def-annotatecatcher}{\textfunc{annotate\_catcher}}}
% \newcommand\annotatecatcher[1]{\annotatecatchername(#1)}
...
% \newcommand\Proseabstractconfiguration{\hyperlink{def-abstractconfigurations}{abstract configuration}}
% \newcommand\Proseabstractconfigurations{\hyperlink{def-abstractconfigurations}{abstract configurations}}
% \newcommand\AbsConfig{\hyperlink{def-abstractconfigurations}{\textsf{AbsConfig}}}
% \newcommand\AbsAbnormal[0]{\hyperlink{def-absabnormal}{\textsf{Abs\_Abnormal}}}
% \newcommand\AbsReturning[0]{\hyperlink{def-absreturning}{\textsf{Abs\_Returning}}}
% \newcommand\AbsContinuing[0]{\hyperlink{def-abscontinuing}{\textsf{Abs\_Continuing}}}
...
% \newcommand\annotateliteralname[0]{\hyperlink{def-annotateliteral}{\textfunc{annotate\_literal}}}
% \newcommand\annotateliteral[1]{\annotateliteralname(#1)}
...
% \newcommand\CannotOverapproximate[0]{\hyperlink{def-cannotoverapproximate}{\overline{\textsf{Approx}}}}
% \newcommand\CannotUnderapproximate[0]{\hyperlink{def-cannotunderapproximate}{\underline{\textsf{Approx}}}}
