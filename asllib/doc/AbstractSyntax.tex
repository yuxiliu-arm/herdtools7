...
\expr \derives\ & \EGetItem(\expr, \N) &\\ \hypertarget{ast-earray}{}
             ...
             |\ & \EGetEnumArray(\overtext{\expr}{base}, \overtext{\expr}{key}) & \hypertarget{ast-lesetenumarray}{}\\
...
\begin{itemize}
  ...
  \item ASTRule.PList (see \secref{ASTRule.PList})
...
\subsubsection{ASTRule.PList \label{sec:ASTRule.PList}}
