...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \secref{BasicOperations} defines the AST for basic operations;
    ...
    \item \secref{LeftHandSideExpressions} defines the AST for assignable expressions;
...
\\
        ...
        \;|\; \overtext{\MOD}{\texttt{"MOD"}} \;|\; \overtext{\SHL}{\shiftleftlexeme}  \;|\; \overtext{\SHR}{\shiftrightlexeme}
        & \hypertarget{ast-rdiv}{} \hypertarget{ast-pow}{} \hypertarget{ast-bvconcat}{} \hypertarget{ast-strconcat}{}
\\
        |\ & \overtext{\RDIV}{\texttt{"/"}} \;|\; \overtext{\POW}{\texttt{"\^{}"}} \;|\; \overtext{\BVCONCAT}{\texttt{"::"}} \;|\; \overtext{\STRCONCAT}{\texttt{"++"}}
        &
\end{flalign*}
